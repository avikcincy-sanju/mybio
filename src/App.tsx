// FINAL BUILD: 11 portfolio cards, Industry Intelligence card, visible Public Research & Publications
...
const PROJECTS = [
  ...
  },
  {
    ...
    desc: 'Live payments and fintech intelligence product for tracking market signals across payment infrastructure, stablecoins, agentic commerce, merchant technology, and emerging financial rails.',
    value: 'Helps product and strategy teams organize relevant industry developments into a focused view for roadmap planning, competitive awareness, and executive decision support.',
    tags: ['Industry Intelligence', 'Payments', 'Market Signals'],
...
// All personal fintech builds are shown in the complete portfolio.
const TOTAL_PERSONAL_FINTECH_BUILDS = PROJECTS.length;
...
type PublicPublicationLink = {
  label: string;
  url: string;
};

type PublicPublicationItem = {
  title: string;
  meta?: string;
  links: PublicPublicationLink[];
};

type PublicPublicationGroup = {
  id: string;
  label: string;
  shortLabel: string;
  description: string;
  ...
  items: PublicPublicationItem[];
};

const PUBLICATION_GROUPS: PublicPublicationGroup[] = [
  {
    id: 'ssrn',
    label: 'SSRN Research Papers',
    shortLabel: 'SSRN',
    description: 'Original research on intelligent payments, autonomous financial execution, governance, and agent identity.',
    accent: '#39FF14',
    icon: FileText,
    items: [
      {
        title: 'The Emergence of Intelligent Payment Systems: An AI-Driven Framework for Multi-Rail Payment Orchestration',
        meta: 'SSRN Abstract ID: 6613638',
        links: [{ label: 'View SSRN', url: 'https://papers.ssrn.com/sol3/papers.cfm?abstract_id=6613638' }],
      },
      {
        title: 'AI-Native Intelligent Payment Systems: Autonomous Financial Execution in Multi-Rail Infrastructure',
        meta: 'SSRN Abstract ID: 6708820',
        links: [{ label: 'View SSRN', url: 'https://papers.ssrn.com/sol3/papers.cfm?abstract_id=6708820' }],
      },
      {
        title: 'A Conceptual Systems Governance Framework for Autonomous Financial Execution: The Sovereign Payment Agent Model',
        meta: 'SSRN Abstract ID: 6765180',
        links: [{ label: 'View SSRN', url: 'https://papers.ssrn.com/sol3/papers.cfm?abstract_id=6765180' }],
      },
      {
        title: 'Verifiable Agent Identity and Delegated Authority in Autonomous Payment Systems: A Trust Architecture for AI-Initiated Financial Transactions',
        meta: 'SSRN Abstract ID: 6920081',
        links: [{ label: 'View SSRN', url: 'https://papers.ssrn.com/sol3/papers.cfm?abstract_id=6920081' }],
      },
    ],
  },
  {
    ...
    description: 'Research examining institutional readiness for stablecoin acquiring infrastructure.',
    accent: '#00BFFF',
    icon: GraduationCap,
    items: [
      {
        title: 'Stablecoin Acquiring Infrastructure: Bridging the Gap Between Payment Viability and Merchant Readiness',
        meta: 'DOI: 10.13140/RG.2.2.12286.55368',
        links: [{ label: 'View DOI', url: 'https://doi.org/10.13140/RG.2.2.12286.55368' }],
      },
    ],
  },
  {
    id: 'zenodo',
    label: 'Zenodo Research & Prototypes',
    shortLabel: 'Zenodo',
    description: 'Archived research records, technical prototypes, and reproducible supporting artifacts.',
    accent: '#39FF14',
    icon: Database,
    items: [
      {
        title: 'AI Route Advisor: Intelligent Payment Rail Recommendation for Cross-Border Transfers',
        meta: 'Working prototype · software and research record',
        links: [
          { label: 'Launch Demo', url: 'https://avikcincy-sanju.github.io/AI_SBC_Route_Advisor/' },
          { label: 'Zenodo', url: 'https://zenodo.org/records/20140629' },
          { label: 'Source', url: 'https://github.com/avikcincy-sanju/AI_SBC_Route_Advisor' },
        ],
      },
      {
        title: 'The Emergence of Intelligent Payment Systems: An AI-Driven Framework for Multi-Rail Payment Orchestration',
        meta: 'Zenodo research record',
        links: [{ label: 'View Record', url: 'https://zenodo.org/records/20261877' }],
      },
      {
        title: 'AI-Native Intelligent Payment Systems: Autonomous Financial Execution in Multi-Rail Infrastructure',
        meta: 'Zenodo research record',
        links: [{ label: 'View Record', url: 'https://zenodo.org/records/20261969' }],
      },
      {
        title: 'A Conceptual Systems Governance Framework for Autonomous Financial Execution: The Sovereign Payment Agent Model',
        meta: 'Zenodo research record',
        links: [{ label: 'View Record', url: 'https://zenodo.org/records/20315696' }],
      },
      {
        title: 'Stablecoin Acquiring Infrastructure: Bridging the Gap Between Payment Viability and Merchant Readiness',
        meta: 'Zenodo research record',
        links: [{ label: 'View Record', url: 'https://zenodo.org/records/20599540' }],
      },
    ],
  },
  {
    ...
    shortLabel: 'Amazon Book',
    description: 'A long-form synthesis of AI, stablecoins, payment infrastructure, and the future of financial systems.',
    accent: '#00BFFF',
    icon: BookOpen,
    items: [
      {
        title: 'The Evolution of Financial Systems in the Age of AI and Stablecoins',
        meta: 'Published on Amazon',
        links: [{ label: 'View Book', url: 'https://www.amazon.com/Evolution-Financial-Systems-Age-Stablecoins/dp/B0GVL7Q4GG/' }],
      },
    ],
  },
  {
    ...
    shortLabel: 'Medium',
    description: 'Long-form analysis on stablecoins, agentic commerce, settlement, payment orchestration, and institutional controls.',
    accent: '#39FF14',
    icon: Newspaper,
    items: MEDIUM_ARTICLES.map((article) => ({
      title: article.title,
      meta: 'Medium article',
      links: [{ label: 'Read Article', url: article.url }],
    })),
  },
  {
    id: 'linkedin',
    ...
    shortLabel: 'LinkedIn',
    description: 'Professional perspectives on the shift from passive payment flows to active intelligence.',
    accent: '#00BFFF',
    icon: Linkedin,
    items: [
      {
        title: 'Shifting Payments from Passive Flows to Active Intelligence',
        meta: 'LinkedIn article',
        links: [{ label: 'Read Article', url: 'https://www.linkedin.com/pulse/shifting-payments-from-passive-flows-active-avik-nandi-dxtfc' }],
      },
    ],
  },
  {
    id: 'finextra',
    label: 'Finextra Articles',
    shortLabel: 'Finextra',
    description: 'Industry analysis on programmable settlement, stablecoin infrastructure, merchant payments, and autonomous treasury.',
    accent: '#39FF14',
    icon: Newspaper,
    items: [
      { title: 'Stablecoins Aren’t Replacing Payments — They’re Rewriting Settlement', meta: 'Finextra', links: [{ label: 'Read Article', url: 'https://www.finextra.com/blogposting/30625/stablecoins-arent-replacing-payments--theyre-rewriting-settlement' }] },
      { title: 'The Science of Settlement: How Stablecoins Are Reshaping Merchant Payments', meta: 'Finextra', links: [{ label: 'Read Article', url: 'https://www.finextra.com/blogposting/30655/the-science-of-settlement-how-stablecoins-are-reshaping-merchant-payments' }] },
      { title: 'When Should a Payment Use Stablecoins? The Decision Framework Institutions Are Building', meta: 'Finextra', links: [{ label: 'Read Article', url: 'https://www.finextra.com/blogposting/30706/when-should-a-payment-use-stablecoins-the-decision-framework-institutions-are-building' }] },
      { title: 'From Rails to Reasoning: Stablecoins in the Next Payments Stack', meta: 'Finextra', links: [{ label: 'Read Article', url: 'https://www.finextra.com/blogposting/30762/from-rails-to-reasoning-stablecoins-in-the-next-payments-stack' }] },
      { title: 'Beyond Checkout: How Stablecoins Will Enable Autonomous Merchant Treasury Networks', meta: 'Finextra', links: [{ label: 'Read Article', url: 'https://www.finextra.com/blogposting/30771/beyond-checkout-how-stablecoins-will-enable-autonomous-merchant-treasury-networks' }] },
      { title: 'Why Loyalty and Rewards Are About to Stop Being “Points” and Start Being Smart Money', meta: 'Finextra', links: [{ label: 'Read Article', url: 'https://www.finextra.com/blogposting/30849/why-loyalty-and-rewards-are-about-to-stop-being-points-and-start-being-smart-money' }] },
      { title: 'Stablecoin Debit: When Your Wallet Becomes a Global, Programmable Checking Account', meta: 'Finextra', links: [{ label: 'Read Article', url: 'https://www.finextra.com/blogposting/30866/stablecoin-debit-when-your-wallet-becomes-a-global-programmable-checking-account' }] },
      { title: 'The Control Plane for Stablecoins', meta: 'Finextra', links: [{ label: 'Read Article', url: 'https://www.finextra.com/blogposting/30909/the-control-plane-for-stablecoins' }] },
      { title: 'The Missing Layer in Stablecoin Payments: Verifiable Intent for Agentic Commerce', meta: 'Finextra', links: [{ label: 'Read Article', url: 'https://www.finextra.com/blogposting/30956/the-missing-layer-in-stablecoin-payments-verifiable-intent-for-agentic-commerce' }] },
      { title: 'Stablecoins as State Machines: The Architecture of Programmable Settlement', meta: 'Finextra', links: [{ label: 'Read Article', url: 'https://www.finextra.com/blogposting/31021/stablecoins-as-state-machines-the-architecture-of-programmable-settlement' }] },
      { title: 'The Stablecoin Orchestration Layer: Who Controls the Stack?', meta: 'Finextra', links: [{ label: 'Read Article', url: 'https://www.finextra.com/blogposting/31048/the-stablecoin-orchestration-layer-who-controls-the-stack' }] },
      { title: 'Stablecoins and the Financial Plumbing Behind Digital Money', meta: 'Finextra', links: [{ label: 'Read Article', url: 'https://www.finextra.com/blogposting/31092/stablecoins-and-the-financial-plumbing-behind-digital-money' }] },
      { title: 'Stablecoins and the Rise of the Internet Financial System', meta: 'Finextra', links: [{ label: 'Read Article', url: 'https://www.finextra.com/blogposting/31158/stablecoins-and-the-rise-of-the-internet-financial-system' }] },
    ],
  },
  {
    id: 'academia',
    label: 'Academia.edu',
    shortLabel: 'Academia.edu',
    description: 'Public academic copies of selected papers on intelligent payments and stablecoin acquiring.',
    accent: '#00BFFF',
    icon: GraduationCap,
    items: [
      {
        title: 'The Emergence of Intelligent Payment Systems: An AI-Driven Framework for Multi-Rail Payment Orchestration',
        meta: 'Academia.edu',
        links: [{ label: 'View Paper', url: 'https://www.academia.edu/167344045/The_Emergence_of_Intelligent_Payment_Systems_An_AI_Driven_Framework_for_Multi_Rail_Payment_Orchestration' }],
      },
      {
        title: 'AI-Native Intelligent Payment Systems: Autonomous Financial Execution in Multi-Rail Infrastructure',
        meta: 'Academia.edu',
        links: [{ label: 'View Paper', url: 'https://www.academia.edu/167344155/AI_Native_Intelligent_Payment_Systems_Autonomous_Financial_Execution_in_Multi_Rail_Infrastructure_An_Evolution_of_Intelligent_Payment_Systems_in_Multi_Rail_Financial_Infrastructure' }],
      },
      {
        title: 'Stablecoin Acquiring Infrastructure: Bridging the Gap Between Payment Viability and Merchant Readiness',
        meta: 'Academia.edu',
        links: [{ label: 'View Paper', url: 'https://www.academia.edu/167344174/Stablecoin_Acquiring_Infrastructure_Bridging_the_Gap_Between_Payment_Viability_and_Merchant_Readiness' }],
      },
    ],
  },
  {
    ...
    description: 'Public AI agent space and source files hosted on Hugging Face.',
    accent: '#39FF14',
    icon: Bot,
    items: [
      {
        title: 'Avik GAIA Final Agent',
        meta: 'Hugging Face Space',
        links: [
          { label: 'Open Space', url: 'https://huggingface.co/spaces/avina1328/avik-gaia-final-agent' },
          { label: 'View Files', url: 'https://huggingface.co/spaces/avina1328/avik-gaia-final-agent/tree/main' },
        ],
      },
    ],
  },
...
function PublicResearchPublications() {
  const publicationGroups = [
    ...PUBLICATION_GROUPS.filter((group) => group.id === 'medium'),
    ...PUBLICATION_GROUPS.filter((group) => group.id !== 'medium'),
  ];
  const [activeGroupId, setActiveGroupId] = useState('medium');
  const activeGroup = publicationGroups.find((group) => group.id === activeGroupId) ?? publicationGroups[0];
  const ActiveIcon = activeGroup.icon;
  const totalPublications = publicationGroups.reduce((sum, group) => sum + group.items.length, 0);

  return (
    <section id="research" className="scroll-mt-16 py-14 relative z-10 border-t border-[#1c1c1c]">
      <div className="max-w-6xl mx-auto px-6">
        <div className="mb-10">
          <div className="section-num mb-3">08 — Public Research & Publications</div>
          <div className="flex flex-wrap items-end justify-between gap-4">
            ...
            <div className="rounded-full border border-[#39FF14]/20 bg-[#39FF14]/5 px-4 py-2 text-[10px] font-black uppercase tracking-[0.2em] text-[#39FF14]">
              {totalPublications} Public Works
            </div>
          </div>
          <p className="text-[#666] text-sm mt-5 max-w-3xl leading-relaxed">
            Peer-accessible research papers, archived technical records, working prototypes, published books, and industry writing across intelligent payments, stablecoins, settlement infrastructure, agentic commerce, and autonomous financial execution.
          </p>
        </div>
            ...
            {publicationGroups.map((group) => {
              ...
              return (
                <button
                  ...
                  className={`rounded-full border px-4 py-2 text-[10px] font-black uppercase tracking-[0.16em] transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#39FF14]/50 ${
                    selected
                      ? 'border-[#39FF14]/40 bg-[#39FF14]/10 text-[#39FF14]'
                      : 'border-[#222] bg-[#0b0b0b] text-[#555] hover:border-[#333] hover:text-white'
                  }`}
                >
                  {group.shortLabel} · {group.items.length}
                </button>
              );
            })}
          </div>
        ...
        <div className="rounded-2xl border border-[#1d1d1d] bg-[#090909] p-5 sm:p-7 mb-5">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div className="flex items-start gap-4">
              <div
                className="flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-xl border"
                style={{ borderColor: `${activeGroup.accent}30`, backgroundColor: `${activeGroup.accent}08` }}
              >
                <ActiveIcon className="h-6 w-6" style={{ color: activeGroup.accent }} />
              </div>
              <div>
                <div className="text-[10px] font-black uppercase tracking-[0.24em] mb-1" style={{ color: activeGroup.accent }}>
                  Selected Collection
                </div>
                <h3 className="text-lg font-black uppercase tracking-wide text-white">{activeGroup.label}</h3>
                <p className="mt-2 max-w-3xl text-sm leading-relaxed text-[#666]">{activeGroup.description}</p>
              </div>
            </div>
            <div className="text-[10px] font-mono uppercase tracking-[0.18em] text-[#444]">
              {String(activeGroup.items.length).padStart(2, '0')} records
            </div>
          </div>
        </div>
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          {activeGroup.items.map((item, index) => (
            <article
              key={`${activeGroup.id}-${item.title}`}
              className="group flex min-h-[220px] flex-col rounded-xl border border-[#1c1c1c] bg-[#0b0b0b] p-6 transition-all duration-200 hover:border-[#333] hover:bg-[#0e0e0e]"
            >
              <div className="mb-5 flex items-start justify-between gap-4">
                <span
                  className="rounded-full border px-2.5 py-1 text-[9px] font-black uppercase tracking-[0.18em]"
                  style={{ color: activeGroup.accent, borderColor: `${activeGroup.accent}30`, backgroundColor: `${activeGroup.accent}07` }}
                >
                  {activeGroup.shortLabel}
                </span>
                <span className="font-mono text-[9px] text-[#333]">
                  {String(index + 1).padStart(2, '0')} / {String(activeGroup.items.length).padStart(2, '0')}
                </span>
              </div>

              <h4 className="mb-3 text-sm font-black leading-snug tracking-wide text-white">
                {item.title}
              </h4>

              {item.meta && <p className="mb-5 text-xs leading-relaxed text-[#555]">{item.meta}</p>}

              <div className="mt-auto flex flex-wrap gap-2 border-t border-[#181818] pt-4">
                {item.links.map((link) => (
                  <a
                    ...
                    className="inline-flex items-center gap-1.5 rounded-md border border-[#252525] px-3 py-2 text-[9px] font-black uppercase tracking-[0.14em] text-[#666] transition-colors hover:border-[#39FF14]/30 hover:text-[#39FF14] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#39FF14]/50"
                  >
                    {link.label}
    ...
    <section id="projects" className="scroll-mt-16 py-14 relative z-10 border-t border-[#1c1c1c]">
      <div className="max-w-6xl mx-auto px-6">
        <div className="reveal mb-8">
          ...
          <p className="text-[#666] text-sm mt-5 max-w-3xl leading-relaxed">
            A broader portfolio of 11 independently created fintech products spanning payment intelligence, payment change implementation, agentic commerce, money movement, stablecoins, BNPL, routing, industry intelligence, and product strategy. All 11 builds are presented below.
          </p>
        </div>
