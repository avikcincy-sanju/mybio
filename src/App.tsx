// FINAL BUILD: 11 portfolio cards, Industry Intelligence card, no news ticker
...
function PublicResearchPublications() {
  const [activeGroupId, setActiveGroupId] = useState('ssrn');
  const activeGroup = PUBLICATION_GROUPS.find((group) => group.id === activeGroupId) ?? PUBLICATION_GROUPS[0];
  const ActiveIcon = activeGroup.icon;
  const totalPublications = PUBLICATION_GROUPS.reduce((sum, group) => sum + group.items.length, 0);
  ...
  return (
    <section id="research" className="scroll-mt-16 py-14 relative z-10 border-t border-[#1c1c1c]">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="reveal mb-7 overflow-x-auto pb-2">
        ...
        <div className="reveal rounded-2xl border border-[#1d1d1d] bg-[#090909] p-5 sm:p-7 mb-5">
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          {activeGroup.items.map((item, index) => (
            <article
              ...
              className="reveal group flex min-h-[220px] flex-col rounded-xl border border-[#1c1c1c] bg-[#0b0b0b] p-6 transition-all duration-200 hover:border-[#333] hover:bg-[#0e0e0e]"
            >
